the project is structured in a way that every one in the system is a user stored in the user entity, a patient can be onboarded into the system and will automatically get a wallet, an appointment can be created for a patient, and a clinic is assigned to the individual
